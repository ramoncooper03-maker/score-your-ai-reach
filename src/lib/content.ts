 ...
 * and consistent: LocalAI Score never claims a permanent "ChatGPT ranking"
 * and never promises that optimization will make an AI recommend a business.
 */

export const BRAND = "LocalAI Score";

export const VARIABILITY_DISCLOSURE =
  "AI-generated answers vary between engines, sessions and phrasing. LocalAI Score runs a fixed set of standardized buyer-intent tests and reports what those tests observed at a point in time. It is not a permanent AI ranking and no result can be guaranteed.";
