...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AIEO Meter measures how your local business appears when AI is asked the questions your customers ask. Standardized tests, deterministic scoring, auditable evidence." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "AIEO Meter — Is AI Recommending Your Business?" },
      { property: "og:description", content: "AIEO Meter measures how your local business appears when AI is asked the questions your customers ask. Standardized tests, deterministic scoring, auditable evidence." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "AIEO Meter — Is AI Recommending Your Business?" },
      { name: "twitter:description", content: "AIEO Meter measures how your local business appears when AI is asked the questions your customers ask. Standardized tests, deterministic scoring, auditable evidence." },
