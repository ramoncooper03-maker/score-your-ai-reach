  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pricing — AIeometer" },
      {
        ...
        content: "Free AI presence check, a $49 Audit, or the $149 Blueprint with implementation guidance.",
      },
    ],
  }),
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 pb-20 pt-16 sm:pt-20">
          <div className="max-w-2xl" style={{ animation: "var(--animate-rise)" }}>
            ...
            <p className="mt-6 text-lg leading-relaxed text-ink-soft">
              Pay for measurement, not promises. Every tier uses the same standardized tests and the same deterministic
              scoring, so results stay comparable across scans.
            </p>
          </div>
          ...
          <p className="mt-12 max-w-3xl text-xs leading-relaxed text-muted-foreground">{VARIABILITY_DISCLOSURE}</p>
        </div>
      </section>
